...
data class RoomChart(
    ...
    var hygieneOther: SnapshotStateList<String> = mutableStateListOf(),
    var linenOther: SnapshotStateList<String> = mutableStateListOf(),
    var deviceOther: SnapshotStateList<String> = mutableStateListOf(),
